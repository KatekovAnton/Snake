...
iosDisplay::iosDisplay() {
    ...
    if (m_obScreenSize.width < m_obScreenSize.height && UIInterfaceOrientationIsLandscape([[ViewController instance] interfaceOrientation])) {
...
void iosDisplay::SetPinchDelegate(DisplayInputDelegate* delegate) {
